/*
  ...
  gengetopt --file-name=cmdline-lsb
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "  -i, --infile=filename   Input file to use  (default=`-')",
  "  File to use as input, give '-' for STDIN",
  "  -o, --outfile=filename  Output file to use  (default=`-')",
  "  File to use as output, give '-' for STDOUT",
  "  -n, --num-lsb=INT       How many LSB to use  (default=`1')",
  "  Number of least significant bytes to hide data in",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->infile_help = gengetopt_args_info_detailed_help[3] ;
  args_info->outfile_help = gengetopt_args_info_detailed_help[5] ;
  args_info->num_lsb_help = gengetopt_args_info_detailed_help[7] ;
  args_info->encode_help = gengetopt_args_info_detailed_help[9] ;
  args_info->decode_help = gengetopt_args_info_detailed_help[10] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->num_lsb_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->num_lsb_given)
    write_into_file(outfile, "num-lsb", args_info->num_lsb_orig, 0);
  if (args_info->encode_given)
    write_into_file(outfile, "encode", 0, 0 );
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:o:n:ed", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'i':	/* Input file to use.  */
          ...
          if (update_arg( (void *)&(args_info->infile_arg), 
              ...
              &(local_args_info.infile_given), optarg, 0, "-", ARG_STRING,
        ...
        case 'o':	/* Output file to use.  */
          ...
          break;
        case 'n':	/* How many LSB to use.  */
        
        
          if (update_arg( (void *)&(args_info->num_lsb_arg), 
               &(args_info->num_lsb_orig), &(args_info->num_lsb_given),
              &(local_args_info.num_lsb_given), optarg, 0, "1", ARG_INT,
              check_ambiguity, override, 0, 0,
              "num-lsb", 'n',
              additional_error))
            goto failure;
        ...
        case 'e':	/* Encode Data.  */
          ...
          if (update_arg( 0 , 
               0 , &(args_info->encode_given),
              &(local_args_info.encode_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "encode", 'e',
              additional_error))
            goto failure;
